...
public class AutoGyroRotate extends Command {
    ...
    public AutoGyroRotate(double turnValue) {
        this(turnValue, TOLERANCE);
    }

    public AutoGyroRotate(double turnValue, double tolerance) {
    ...
    protected boolean isFinished() {
        boolean ret = Robot.drive.gyroAngle() > _turnValue - _tolerance &&
                Robot.drive.gyroAngle() < _turnValue + _tolerance;
